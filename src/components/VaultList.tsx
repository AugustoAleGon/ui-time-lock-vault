  ...
  walletClient: any
    ...
    async function withdrawVault(vaultId: number) {
        ...
        try {
            ...
            address: '0xe325aa89a33edc1266c1ba087122672d1f333a03', // Your contract address
            abi: abi,
    ...
    try {
        ...
        const vault = await publicClient.readContract({
            address: '0xe325aa89a33edc1266c1ba087122672d1f333a03', // Replace with your deployed contract address
            abi: abi,
            functionName: 'vaults',
            args: [BigInt(index)]
        });
...
{/* Vaults List */}
    ...
    <div className="space-y-3">
        {vaults.map((vault) => (
            <React.Fragment key={`${vault.id}-${vault.owner}`}>
